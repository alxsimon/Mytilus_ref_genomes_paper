...
\begin{figure}[h]
	...
	\caption{Busco scores on the metazoa\_odb10 (left panels) and mollusca\_odb10 (right panels) databases for each assembly MgalMED, MeduEUS and MeduEUN (top to bottom panels) across several versions (v1, v4, v5, v6, v7).}
	\label{supfig:busco}
\end{figure}
