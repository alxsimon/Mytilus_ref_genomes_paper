...
With a limited budget of $\sim$3000€ per genome, we managed to produce draft genomes of enough quality to be useful
...
Species tree using 1300 orthogroups with minimum of 81.8\% of species having single-copy genes in any orthogroup (value automatically selected by \texttt{OrthoFinder}).
